...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['?0p1`2#8&', 0.2], //From 0% to 19%
		['$9j@', 0.4], //From 20% to 39%
		['?#!', 0.5], //From 40% to 49%
		['??', 0.6], //From 50% to 59%
		['Huh?', 0.69], //From 60% to 68%
		['Good', 0.7], //69%
		['Satisfactory', 0.8], //From 70% to 79%
		['Outstanding', 0.9], //From 80% to 89%
		['Adept', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		healthBarBG.visible = !ClientPrefs.hideHealthBar;
		healthBarBG.xAdd = -4;
		healthBarBG.yAdd = -4;
		add(healthBarBG);
		...
		// healthBar
		healthBar.visible = !ClientPrefs.hideHealthBar;
		...
		iconP1.visible = !ClientPrefs.hideHealthBar;
		iconP1.alpha = ClientPrefs.healthBarAlpha;
		add(iconP1);

		iconP2 = new HealthIcon(dad.healthIcon, false);
		iconP2.y = healthBar.y - 75;
		iconP2.visible = !ClientPrefs.hideHealthBar;
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "COWARD", 512);
  ...
  public function addShaderToCamera(cam:String,effect:ShaderEffect){//stolen from nebula_zorua lol
  ...
  public function clearShaderFromCamera(cam:String){
	...
	function goodNoteHit(note:Note):Void
	{
		if (!note.wasGoodHit)
		{
			...
			var isSus:Bool = note.isSustainNote; //GET OUT OF MY HEAD, GET OUT OF MY HEAD, GET OUT OF MY HEAD HELP HELP HELP HELP WHY IS THIS IN THE SOURCE CODE
