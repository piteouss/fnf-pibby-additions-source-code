...
class GraphicsSettingsSubState extends BaseOptionsMenu //if you are trying to add a new option, you have to go to clientprefs.hx too to add the option there or you're going to fuck up and the checkmark wont appear for your option
{
	public function new()
	{
		title = 'Graphics';
